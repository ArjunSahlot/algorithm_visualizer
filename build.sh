...
&& rm -rf master.zip \
&& mkdir -p $1 \
&& cp -r $temporary_dir/algorithm_visualizer-master $1/algorithm_visualizer \
&& rm -rf $temporary_dir \
&& echo -e "\033[0;32mSuccessfully downloaded to $1/algorithm_visualizer\033[0m" \
