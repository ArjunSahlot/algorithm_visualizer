...
file = "algorithm_visualizer-"
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/algorithm_visualizer/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/algorithm_visualizer/archive/master.zip", tmp)
    file += "master"
